...
static const yytype_int8 yyrhs[] =
{
      ...
      38,    -1,    43,    -1,    -1,    42,     9,    39,    22,    -1,
      -1,    -1,    42,     9,    40,    26,    10,    41,    27,    22,
      -1,     5,    -1,     7,    -1,    -1,    42,     9,    44,    24,
      45,    25,    49,    -1,    46,    -1,     7,    -1,    46,    23,
      47,    -1,    47,    -1,    42,     9,    -1,    -1,    42,     9,
      48,    26,    27,    -1,    28,    50,    51,    29,    -1,    50,
      38,    -1,    -1,    51,    52,    -1,    -1,    53,    -1,    49,
      -1,    54,    -1,    55,    -1,    56,    -1,    57,    22,    -1,
      22,    -1,     3,    24,    57,    25,    52,    -1,     3,    24,
      57,    25,    52,     4,    52,    -1,     8,    24,    57,    25,
      52,    -1,     6,    22,    -1,     6,    57,    22,    -1,    58,
      21,    57,    -1,    60,    -1,     9,    -1,    -1,     9,    59,
      26,    57,    27,    -1,    62,    61,    62,    -1,    62,    -1,
      16,    -1,    15,    -1,    17,    -1,    18,    -1,    19,    -1,
      20,    -1,    62,    63,    64,    -1,    64,    -1,    11,    -1,
      12,    -1,    64,    65,    66,    -1,    66,    -1,    13,    -1,
      14,    -1,    24,    57,    25,    -1,    58,    -1,    67,    -1,
      10,    -1,    -1,     9,    68,    24,    69,    25,    -1,    70,
      -1,    -1,    70,    23,    57,    -1,    57,    -1
};
...
{
       0,    26,    26,    28,    36,    38,    39,    42,    41,    54,
      63,    53,    72,    77,    84,    83,    98,   103,   108,   116,
     118,   127,   126,   141,   153,   165,   167,   179,   181,   182,
     183,   184,   185,   187,   188,   193,   199,   207,   214,   218,
     224,   232,   234,   240,   239,   252,   258,   260,   265,   270,
     275,   280,   285,   291,   297,   299,   304,   310,   316,   318,
     323,   329,   333,   334,   335,   342,   341,   354,   355,   357,
     365
};
#endif
...
static const char *const yytname[] =
{
  ...
  "LBRACKET", "RBRACKET", "LBRACE", "RBRACE", "ERROR", "ENDFILE",
  "COMMENTERROR", "NO_ELSE", "$accept", "program", "declaration_list",
...
static const yytype_uint8 yystos[] =
{
      ...
      66,    67,    24,    22,    57,    24,    59,    68,    57,    22,
      21,    11,    12,    15,    16,    17,    18,    19,    20,    61,
      63,    13,    14,    65,    57,    22,    57,    26,    24,    25,
      57,    58,    62,    64,    66,    25,    25,    57,    57,    69,
      70,    52,    52,    27,    25,    23,     4,    57,    52
};
...
#line 42 "cm.y"
    {
							(yyval) = newDeclNode(KindVar);
							(yyval)->child[0] = (yyvsp[(1) - (2)]);
							(yyval)->child[1] = newValNode(KindId);

							(yyval)->child[1]->attr.name = copyString(tokenBefore);
						}
    break;
...
#line 54 "cm.y"
    {
							(yyval) = newDeclNode(KindArray);
							(yyval)->child[0] = (yyvsp[(1) - (2)]);
							(yyval)->child[1] = newValNode(KindId);
							(yyval)->child[2] = newValNode(KindConst);
...
#line 63 "cm.y"
    {
							(yyval) = (yyvsp[(3) - (5)]);
							(yyval)->child[2]->attr.val = atoi(tokenString);
						}
    break;
...
#line 142 "cm.y"
    {
							(yyval) = newStmtNode(KindCompound);
...
#line 235 "cm.y"
    {
							(yyval) = newValNode(KindId);
							(yyval)->attr.name = copyString(tokenBefore);
						}
    break;
...
#line 240 "cm.y"
    {
							(yyval) = newStmtNode(KindSubscript);
							(yyval)->child[0] = newValNode(KindId);

							(yyval)->child[0]->attr.name = copyString(tokenBefore);
						}
    break;
